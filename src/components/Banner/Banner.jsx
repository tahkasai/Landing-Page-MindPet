        ...
        <>
            ...
            <section className={styles.topicos}>
                <Topicos 
                    ...
                    titulo='Sistema Inteligente com Inteligência artificial' 
                    texto='Sensores integrados e IA que interpretam sinais corporais e comportamentais do seu pet'
                />

                <Topicos 
                    icon='fa-solid fa-heart-circle-plus' 
                    titulo='Mapeamento de bem-estar' 
                    texto='Acompanha em tempo real o humor, nível de atividade e conforto do seu companheiro.'
                />

                <Topicos 
                    icon='fa-solid fa-comments' 
                    titulo='Microchip e coleira com alto-falante' 
                    texto='O chip envia informações para o app e reproduz alertas sonoros personalizados na coleira.'
                />
            </section>
        </>
    );
